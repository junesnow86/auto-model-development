...
sys.path.append("/home/yileiyang/workspace/DNNGen/auto_model_dev/generate_samples")
from generate_utils import Sample


def get_ds_desc(ds_index_name):
    file_path = os.path.join("/mnt/msrasrg/yileiyang/DNNGen/auto_model_dev/dataset_desc", ds_index_name)
    with open(file_path, "r") as f:
        ds_desc = json.load(f)
    return ds_desc["name"], ds_desc["content"]

def get_task_desc(task_index_name):
    file_path = os.path.join("/mnt/msrasrg/yileiyang/DNNGen/auto_model_dev/task_desc", task_index_name)
    with open(file_path, "r") as f:
...
def get_graphml(model_name):
    ...
    file_path = os.path.join("/mnt/msrasrg/yileiyang/DNNGen/auto_model_dev/xml/huggingface/nlp", model_name)
    with open(file_path, "r") as f:
        return f.readline()
...
if __name__ == "__main__":
    sample_save_root = "/mnt/msrasrg/yileiyang/DNNGen/auto_model_dev/samples/huggingface"
    mapping_root = "/mnt/msrasrg/yileiyang/DNNGen/auto_model_dev/mapping/huggingface/triples"
